...
import type { ProductSalesDto } from "@/types/sales";
      ...
      <Table size="small">
        <TableHead>
          <TableRow>
            ...
            <TableCell
              align="right"
              sortDirection={sortKey === "totalQuantity" ? sortDir : false}
            >
              <TableSortLabel
            ...
            <TableCell
              align="right"
              sortDirection={sortKey === "orderCount" ? sortDir : false}
            >
              <TableSortLabel
            ...
            <TableCell
              align="right"
              sortDirection={sortKey === "totalSales" ? sortDir : false}
            >
              <TableSortLabel
